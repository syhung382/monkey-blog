    ...
    >
      ...
      {image && (
        <>
          ...
          <button
            className="absolute z-10 flex items-center justify-center invisible w-10 h-10 text-red-500 transition-all bg-white rounded-full opacity-0 cursor-pointer group-hover:opacity-100 group-hover:visible"
